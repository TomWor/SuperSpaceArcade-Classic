...
[AddComponentMenu("BitMonsterFlux/Track/TrackGenerator")]
...
public class TrackGenerator : MonoBehaviour
{
    ...
    {
        List<GameObject> spawnList = this.spawns.FindAll(p => spawnTypes.Contains(p.GetComponent<Spawn>().spawnType));
    ...
    public void LateUpdate()
    {
        ...
        if (currentTrackTileResult) this.currentTrackTile = currentTrackTileResult;
